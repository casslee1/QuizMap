...
function GuessDistribution(props) {
  const barWidthZero = (props.daysOfZeroScore === 0) ? "8" : Math.floor((props.daysOfZeroScore / props.timesPlayed) * 80) + 4;
  const barWidthOne = (props.daysOfOneScore === 0) ? "8" : Math.floor((props.daysOfOneScore / props.timesPlayed) * 80) + 4;
  const barWidthTwo = (props.daysOfTwoScore === 0) ? "8" : Math.floor((props.daysOfTwoScore / props.timesPlayed) * 80) + 4;
  const barWidthThree = (props.daysOfThreeScore === 0) ? "8" : Math.floor((props.daysOfThreeScore / props.timesPlayed) * 80) + 4;
  const barWidthFour = (props.daysOfFourScore === 0) ? "8" : Math.floor((props.daysOfFourScore / props.timesPlayed) * 80) + 4;
